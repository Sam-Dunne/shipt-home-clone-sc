    ...
    return (
        <>
            <HeroContainer>
                ...
                <br></br>
                <HeroH3>This Input fetches data for Countries, and responsively displayed styled with CSS Grid, and has input and response validation, and utilizes hooks useState, useEffect, useRef</HeroH3>
